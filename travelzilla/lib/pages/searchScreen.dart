...
import 'package:travelzilla/Assistants/requestAssistant.dart';
import 'package:travelzilla/DataHandler/appData.dart';
import 'package:travelzilla/Models/address.dart';
import 'package:travelzilla/Models/placePredictions.dart';
import 'package:travelzilla/configMaps.dart';
                ...
                children: [
                  ...
                  Stack(
                    children: [
                      ...
                      Center(
                        child: Text("Where to Go?", style: TextStyle(fontSize: 25.0, fontFamily: "Brand-Bold"),),
                      ),
                    ],
                  ),
                  ...
                  Row(
                    children: [
                      Icon(Icons.location_on_outlined, size: 30.0, color: Colors.black,),
                  ...
                  Row(
                    children: [
                      Icon(Icons.local_taxi, size: 30.0, color: Colors.black,),
